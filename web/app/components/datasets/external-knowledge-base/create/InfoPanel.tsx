      ...
      <div className='flex min-w-[240px] w-full p-6 flex-col items-start gap-3 self-stretch rounded-xl bg-background-section'>
        ...
        <p className='flex flex-col items-start gap-2 self-stretch'>
          ...
          <span className='text-text-tertiary system-sm-regular'>
            ...
            <a className='text-text-accent system-sm-regular ml-1' href='/docs/guides/knowledge-base/external-knowledge-api-documentation' target='_blank' rel="noopener noreferrer">
              {t('dataset.connectDatasetIntro.content.link')}
            </a>
            {t('dataset.connectDatasetIntro.content.end')}
          </span>
          <a className='self-stretch text-text-accent system-sm-regular' href='/docs/guides/knowledge-base/connect-external-knowledge' target='_blank' rel="noopener noreferrer">
