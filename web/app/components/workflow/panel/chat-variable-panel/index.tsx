        ...
        <div className='shrink-0 px-3 pt-2.5 pb-2'>
          <div className='relative p-3 radius-2xl bg-background-section-burn'>
            ...
            <div className='mt-1 mb-4 system-sm-regular text-text-secondary'>
              ...
              <a target='_blank' rel='noopener noreferrer' className='text-text-accent' href={locale !== LanguagesSupported[1] ? '/docs/guides/workflow/key_concepts#conversation-variables' : `/docs/v/${locale.toLowerCase()}/guides/workflow/key_concept#hui-hua-bian-liang`}>{t('workflow.chatVariable.docLink')}</a>
            </div>
