const translation = {
  ...
  welcome: '👋 Welcome to Base, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Base Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Base',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Base and we will send you a password reset email.',
