const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Base account',
    langGeniusAccountTip: 'Your Base account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Base to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Base allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Base\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Base {{version}} is now available.',
    latestAvailable: 'Base {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
